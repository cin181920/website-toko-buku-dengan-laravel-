...
<body>
 ...
 @if(session()->has('success'))
  ...
  @csrf
  <div class="mb-3">
    <label for="card_name" class="form-label">Name card</label>
    @error('card_name')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
        @enderror
    <input type="text" name="card_name"class="form-control"  @error('card_name') is-invalid @enderror  id="card_name" required value="{{old('name_card')}}">
  </div>
 ...
 <div class="mb-3">
    <label for="credit_card_number" class="form-label">Credit Card Number</label>
     @error('credit_card_number')
        ...
        @enderror
    <input type="number" name="credit_card_number"class="form-control"  @error('credit_card_number') is-invalid @enderror  id="jumlah_game" required value="{{old('jumlah_game')}}">
  </div>
 ...
 <div class="mb-3">
    <label for="expire_date" class="form-label">Expire Date</label>
     @error('expire_date')
        ...
        @enderror
    <input type="text" name="expire_date"class="form-control"  @error('expire_date') is-invalid @enderror  id="nama_game" required value="{{old('nama_game')}}">
  </div>
   ...
   <div class="mb-3">
    <label for="cvv" class="form-label">CVC/CVV</label>
     @error('cvv')
        ...
        @enderror
    <input type="number" name="cvv"class="form-control"  @error('cvv') is-invalid @enderror  id="jumlah_game" required value="{{old('jumlah_game')}}">
  </div>
   ...
   <div class="mb-3">
    <label for="zip" class="form-label">ZIP</label>
     @error('zip')
        ...
        @enderror
    <input type="number" name="zip"class="form-control"  @error('zip') is-invalid @enderror  id="zip" required value="{{old('zip')}}">
  </div>
...
<div class="mb-3">
    ...
    @error('country')
        ...
        @enderror
    <input type="text" name="country"class="form-control"  @error('country') is-invalid @enderror  id="country" required value="{{old('country')}}">
  </div>


<div class="mb-3">
    <label for="total" class="form-label">Total yang akan di bayar (RP)</label>
     @error('total')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
        @enderror
    <input type="number" name="total"class="form-control"  @error('total') is-invalid @enderror  id="total" required value="{{old('total')}}">
  </div>
