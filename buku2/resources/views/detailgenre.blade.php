    ...
    <div id="app">
        ...
        <main class="py-4">
         ...
         <div class="row justify-content-center">
            <div class="card">
            <div class="card-body">
            <h1 class="card-title mt-3"> Detail Genre {{ $genre->name}}  </h1>
            <p class="card-text mt-4">Nama Genre:{{ $genre->name}}</p>
            <p class="card-text">{{ $genre->penjelasan}}</p>
            <a href="/admin-home" class="btn btn-success mt-3">Back</a>
