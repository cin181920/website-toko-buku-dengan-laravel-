    ...
    <div id="app">
        ...
        <main class="py-4">
         ...
         <div class="row justify-content-center">
            <div class="card">
            <div class="card-body">
            <h1 class="card-title mt-3"> Detail Buku {{ $buku->judul}}  </h1>
             <img src="{{$buku->gambar}}" width="300" height="400">
            <p class="card-text mt-4">Nama:{{ $buku->judul}}</p>
            <p class="card-text">Author:{{ $buku->penulis}}</p>
            <p class="card-text">Harga:IDR{{ $buku->harga}}</p>
            <p class="card-text">Sinopsis:{{ $buku->sinopsis}}</p>
            <p class="card-text">Genre:{{ $buku->genre->name}}</p>

              <ul>
            <button class="btn-outline-info"><a class="button2" href="/order">Order</a></button>
